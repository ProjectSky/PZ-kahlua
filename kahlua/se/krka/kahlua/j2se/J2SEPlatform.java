...
public class J2SEPlatform implements Platform {
	...
	public void setupEnvironment(KahluaTable env) {
		...
		KahluaUtil.setupLibrary(env, workerThread, "lua/system/stdlib");

		try {
			LuaClosure closure = LuaCompiler.loadis(new FileInputStream(
					"lua/system/serialize.lua"), "serialize.lua", env);
